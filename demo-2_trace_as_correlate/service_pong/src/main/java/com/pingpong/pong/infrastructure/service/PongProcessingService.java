package com.pingpong.pong.infrastructure.service;
 ...
 * main "performance hazard" span within the current trace (same trace_id propagated from ping).
 */
@Service
public class PongProcessingService {
    ...
    @Observed(name = "pong.processing.process", contextualName = "PongProcessingService.process")
