package com.pingpong.pong.infrastructure.persistence;
 ...
 * span inside the current trace (inherits the single trace_id propagated from ping).
 */
@Repository
public class PongRepository {
    ...
    @Observed(name = "pong.repository.save", contextualName = "PongRepository.save")
